...
class UsabaazarController extends AbstractActionController
 {
     ...
     public function registerAction()
     {
         ...
         if($request->isPost()){
             ...
             $usabaazar = new \Usabaazar\Model\Usabaazar();
             $form->setInputFilter($usabaazar->getInputFilter());
             $form->setData($request->getPost());
             
             if($form->isValid()){
                 
                 $usabaazar->exchangeArray($form->getData());                
                ...
                $sql="INSERT INTO register (firstName, lastName, companyName, email, password, address1, address2, countrySelect, city, areaCode, phoneNumber)"
                        . "VALUES ('".$usabaazar->firstName."', '".$usabaazar->lastName."', '".$usabaazar->companyName."', '".$usabaazar->email."','".$usabaazar->password."','".$usabaazar->address1."','".$usabaazar->address2."','".$usabaazar->countrySelect."','".$usabaazar->city."','".$usabaazar->areaCode."','".$usabaazar->phoneNumber."')";

                if (mysqli_query($conn, $sql)) {
                    
                } else {
                    echo "Error in Registration <br>" ;
                }
     ...
     public function getUsabaazarTable()
     {
         if(!$this->usabaazarTable){
             $sm = $this->getServiceLocator();
             $this->usabaazarTable = $sm->get('Usabaazar\Model\UsabaazarTable');
            
         }
         return $this->usabaazarTable;
     }
     ...
     {  
         ...
         $resultHtml=$this->setSearchAmazonDisplay();
     ...
     protected function setSearchAmazonDisplay(){
         $returnHtml='';
         ...
         if(isset($_GET['searchQuery'])){
             ...
             $returnHtml=  $this->displayAmazonItems($searchQuery, $itemsPerPage, $pageNumber, $currentURL);
...
protected function displayAmazonItems($searchQuery,$itemsPerPage,$pageNumber,$cURL)
                {
        ...
        $public_key = 'AKIAIEQDRTEY4PR7QSIA';
        $secret_key = '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';
        ...
        $params_array = array(
                ...
                'ResponseGroup' =>'Medium',
                    ...
                    $resp = $amazon_api->sendRequest($params_array);;
                    ...
                    $count=0;
                    $entryPerPage=10;
                    if($entryPerPage>$resp->Items->TotalResults){
                        $entryPerPage=$resp->Items->TotalResults;
                    }
                        
                    for($count=0;$count<($itemsPerPage) && $count<($entryPerPage);$count++){
                ...
                //        simplexml_load_file($itemApicall.$resp->searchResult->item[$count*3]->itemId)->Item->PictureURL
                    ...
                    if($resp->Items->Item[$count]){
                    $results .=		   '<div class="col_1_of_single1 span_1_of_single1" style="width:96%"><a href="ebayitemdisplay?_itemId='.$resp->Items->Item[$count]->ASIN.'">
                                                     <div class="view1 view-fifth1">
                                                          <div class="top_box">
                                                                <h3 class="m_1">'.$resp->Items->Item[$count]->ItemAttributes->Title.'</h3>

                                                         <div class="grid_img">
                                                                   <div class="css3"><img src="'.$resp->Items->Item[$count]->MediumImage->URL.'" alt=""/></div>
                                                                  <div class="mask1">
                                                        <div class="info">Quick View</div>
                                                        <div class="info">Similar Items</div>
                                                          </div>
                                            </div>
                                       <div class="price">'.$resp->Items->Item[$count]->ItemAttributes->ListPrice->FormattedPrice.$resp->Items->Item[$count]->ItemAttributes->ListPrice->CurrencyCode.'</div>
                                                           </div>
                                                            </div>
...
//                    if($resp->Items->Item[$count*3+1]){
//                                $results .='<div class="col_1_of_single1 span_1_of_single1"><a href="ebayitemdisplay?_itemId='.$resp->Items->Item[$count*3+1]->ASIN.'">
//                                                     <div class="view1 view-fifth1">
//                                                          <div class="top_box">
//                                                                <h3 class="m_1">'.$resp->Items->Item[$count*3+1]->ItemAttributes->Manufacturer.'</h3>
//
//                                                         <div class="grid_img">
//                                                                   <div class="css3"><img src="'.$resp->Items->Item[$count*3+1]->MediumImage->URL.'" alt=""/></div>
//                                                                  <div class="mask1">
//                                                        <div class="info">Quick View</div>
//                                                          </div>
//                                            </div>
//                                       <div class="price">'.$resp->Items->Item[$count*3+1]->ItemAttributes->ListPrice->FormattedPrice.$resp->Items->Item[$count*3+1]->ItemAttributes->ListPrice->CurrencyCode.'</div>
//                                                           </div>
//                                                            </div>
//                                                           <span class="rating1">
...
//                                                </a></div>';
//                    }
//                       if($resp->Items->Item[$count*3+2]){
//                                $results .='<div class="col_1_of_single1 span_1_of_single1"><a href="ebayitemdisplay?_itemId='.$resp->Items->Item[$count*3+2]->ASIN.'">
//                                                     <div class="view1 view-fifth1">
//                                                          <div class="top_box">
//                                                                <h3 class="m_1">'.$resp->Items->Item[$count*3+2]->ItemAttributes->Manufacturer.'</h3>
//
//                                                         <div class="grid_img">
//                                                                   <div class="css3"><img src="'.$resp->Items->Item[$count*3+2]->MediumImage->URL.'" alt=""/></div>
//                                                                  <div class="mask1">
//                                                        <div class="info">Quick View</div>
//                                                          </div>
//                                            </div>
//                                       <div class="price">'.$resp->Items->Item[$count*3+2]->ItemAttributes->ListPrice->FormattedPrice.$resp->Items->Item[$count*3+2]->ItemAttributes->ListPrice->CurrencyCode.'</div>
//                                                           </div>
//                                                            </div>
//                                                           <span class="rating1">
//                                                        <input type="radio" class="rating-input" id="rating-input-1-5" name="rating-input-1">
...
//                       }
                ...
                function addToURL( $key, $value, $url) {
                    ...
                    $displayPageNumber ='<div class="mens-toolbar"><div class="pager"><ul class="dc_pagination dc_paginationA dc_paginationA06"><li><a href="#" class="previous">Pages</a></li>';
                                ...
                                $totalPages=$resp->Items->TotalPages;
                                $pageNumberCount=1;
                                $pageNumberCounter;
